...
import cn.skyhor.realtime.bean.VisitorStats;
import cn.skyhor.realtime.utils.ClickHouseUtil;
import cn.skyhor.realtime.utils.DateTimeUtil;
...
public class VisitorStatsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> ujDS = env.addSource(MyKafkaUtil.getKafkaSource(userJumpDetailSourceTopic, groupId));
        ...
        SingleOutputStreamOperator<VisitorStats> result = windowedStream.reduce(new ReduceFunction<VisitorStats>() {
            ...
            public VisitorStats reduce(VisitorStats value1, VisitorStats value2) throws Exception {
                ...
                (stringStringStringStringTuple4, window, input, out) -> {
