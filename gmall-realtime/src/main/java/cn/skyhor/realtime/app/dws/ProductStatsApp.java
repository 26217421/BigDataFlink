...
import cn.skyhor.realtime.bean.ProductStats;
import cn.skyhor.realtime.common.GmallConstant;
...
public class ProductStatsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> payDS = env.addSource(MyKafkaUtil.getKafkaSource(paymentWideSourceTopic, groupId));
