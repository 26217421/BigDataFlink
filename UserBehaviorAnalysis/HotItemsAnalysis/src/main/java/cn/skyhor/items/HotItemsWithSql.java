...
import cn.skyhor.items.beans.UserBehavior;
...
public class HotItemsWithSql {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
        DataStream<String> inputStream = env.readTextFile("D:\\dev\\work\\BigDataFlink" +
                "\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv");
